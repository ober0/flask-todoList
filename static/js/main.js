function newElement() {
        ...
        fetch('/newtask', {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    // После добавления новой задачи обновляем обработчики событий
                    updateEventHandlers();
                } else {
                    document.getElementById('error').innerText = ('Ошибка:' + result.message);
                            setTimeout(function () {
    ...
    // Вызываем функцию updateEventHandlers при загрузке страницы
